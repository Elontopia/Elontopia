...
contract Elontopia is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6aEe7C162437bD25970A12DAeDb1068471ef79Ae); // Marketing Address
    ...
    string private _name = "Elontopia";
    string private _symbol = "ELONTOPIA";
